...
export default {
  ...
  data() {
    return {
      erc20: '0x2A56A981F001b6e4e927BbaB2f9ff41FEAa0f5Af',
      selectedAddress: 'cosmos1w6dmrs3rr7p7gtzhtjwpudxjncwn76uxclhpfe',
    }
  },
  computed: {
    chains() {
      const { data } = addressDecode('cosmos1w6dmrs3rr7p7gtzhtjwpudxjncwn76uxclhpfe')
